...
precios <- tibble::tribble(~unidad, ~objeto, ~precio, ~imagen, ~ancho,
                           ...
                           1000, "toneladas de palta", 5000*1000, "palta.png", 32,
                           10000, "helados Centella", 300*10000, "centella.png", 32,
                           1000, "completos italianos", 2500*1000, "completo.png", 32,
                           completo_container, "container lleno de completos italianos", 2500*completo_container, "completo.png", 32,
                           1000, "pizzas familiares", 17000*1000, "pizza.svg", 32,
                           pizzas_container, "container lleno de pizzas familiares", 17000*pizzas_container, "pizza.svg", 32,
                           200, "computadores gamer", 750000*200, "computer.svg", 32,
                           200, "computadores portátiles", 280000*200, "laptop.svg", 32,
                           300, "sueldos mínimos", 500000*300, "money.svg", 32,
