...
precios <- tibble::tribble(~unidad, ~objeto, ~precio, ~imagen, ~ancho,
                           ...
                           1, "sueldos mínimos", 529000, "money.svg", 32,
                           100, "computadores portátiles", 300000*100, "laptop.svg", 32,
                           100, "computadores gamer", 750000*100, "computer.svg", 32,
                           1, "autos nuevos (chicos)", 10390000, "car.svg", 32,
                           1, "camionetas nuevas", 18076000, "truck.svg", 32,
                           100, "toneladas de palta", 5000*100, "palta.png", 32,
